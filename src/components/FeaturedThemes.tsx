                      ...
                      <Link to={`/template/${template.id}`} className="block">
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <button className="text-[11px] font-semibold text-gray-500 border border-gray-200 rounded px-2.5 py-1 hover:border-green-500 hover:text-green-600 transition-colors">
                              Live Preview
                            </button>
                          </div>
                        </div>
